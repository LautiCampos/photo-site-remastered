...
const HeroSection = () => {
  return (
    <section className="bg-gradient-to-br from-greenprimary-light to-orangeaccent-light px-2 md:px-0 pt-6 pb-12 md:pb-20 relative overflow-hidden">
      <div className="container mx-auto flex flex-col-reverse md:flex-row items-center md:items-stretch gap-8 md:gap-10">
        ...
        <div className="flex-1 flex flex-col justify-center items-start mt-4 md:mt-12 animate-fade-in">
          ...
          <h1 className="font-playfair text-greenprimary-dark text-[2.4rem] md:text-[4rem] leading-tight font-bold mb-3 drop-shadow">
            Bienvenido a Arplas
          </h1>
          <p className="text-greenprimary-dark max-w-xl mb-4 ml-1 text-base md:text-lg font-light">
          ...
          <div className="flex gap-3 mt-2">
            <a
              href="#services"
              className="px-6 py-2 rounded-full bg-greenprimary DEFAULT text-white font-semibold shadow-md hover:bg-greenprimary-dark transition hover-scale text-base"
            >
              Ver Servicios
            </a>
            <a
              href="#contact"
              className="px-6 py-2 rounded-full bg-orangeaccent DEFAULT text-white font-semibold shadow-md hover:bg-orangeaccent-dark transition hover-scale text-base"
            >
              Contáctanos
            </a>
          </div>
