  ...
  return (
    <section id="about" className="bg-offwhite px-2 md:px-0 py-10 md:py-20">
      <div className="container mx-auto">
        <h2 className="font-playfair text-greenprimary-dark text-4xl md:text-5xl mb-10 animate-fade-in">Quiénes Somos</h2>
        <div className="grid md:grid-cols-2 gap-6 bg-offwhite md:border md:border-grayborder rounded-xl overflow-hidden">
          {/* Historia */}
          <div className="p-6 flex flex-col justify-between min-h-[270px] animate-fade-in [animation-delay:100ms]">
            <div>
              <div className="text-lg font-semibold text-greenprimary-dark mb-2">Nuestra Historia</div>
              <p className="text-sm text-greenprimary-dark mb-4">
          ...
          <div className="flex items-center justify-center bg-transparent animate-scale-in [animation-delay:200ms]">
            <img
              ...
              alt="Equipo Arplas"
              className="rounded-lg shadow-md w-[80%] max-w-[330px] aspect-square object-cover border-2 border-greenprimary-light"
            />
          </div>
        </div>
      </div>
