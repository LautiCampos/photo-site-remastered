  ...
  return (
    <section id="about" className="bg-offwhite px-2 md:px-0 py-10 md:py-20">
      <div className="container mx-auto">
        <h2 className="font-playfair text-primarybrown text-4xl md:text-5xl mb-10">Quiénes Somos</h2>
        <div className="grid md:grid-cols-2 gap-6 bg-offwhite md:border md:border-gray-300 rounded-xl overflow-hidden">
          ...
          <div className="p-6 flex flex-col justify-between min-h-[270px]">
            ...
            <a
              href="#contact"
              className="inline-block mt-2 px-6 py-2 text-sm font-normal rounded-full bg-accentburgundy text-white shadow-sm hover:brightness-90 active:scale-95 transition-all self-start"
            >
              Conócenos
            </a>
          </div>
